...
func (a *UniverseApiService) PostUniverseIds(ctx context.Context, names []string, localVarOptionals *UniverseApiPostUniverseIdsOpts) (PostUniverseIdsOk, *http.Response, error) {
	var (
...
func (a *UniverseApiService) PostUniverseNames(ctx context.Context, ids []int32, localVarOptionals *UniverseApiPostUniverseNamesOpts) ([]PostUniverseNames200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
