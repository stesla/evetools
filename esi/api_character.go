 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param characterId An EVE character ID
 * @param optional nil or *CharacterApiGetCharactersCharacterIdStatsOpts - Optional Parameters:
     * @param "Datasource" (optional.String) -  The server name you would like data from
     * @param "IfNoneMatch" (optional.String) -  ETag from a previous request. A 304 will be returned if this matches the current ETag
     * @param "Token" (optional.String) -  Access token to use if unable to set a header
...
type CharacterApiGetCharactersCharacterIdStatsOpts struct { 
	Datasource optional.String
	IfNoneMatch optional.String
	Token optional.String
}

func (a *CharacterApiService) GetCharactersCharacterIdStats(ctx context.Context, characterId int32, localVarOptionals *CharacterApiGetCharactersCharacterIdStatsOpts) ([]GetCharactersCharacterIdStats200Ok, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []GetCharactersCharacterIdStats200Ok
	)
...
func (a *CharacterApiService) PostCharactersAffiliation(ctx context.Context, characters []int32, localVarOptionals *CharacterApiPostCharactersAffiliationOpts) ([]PostCharactersAffiliation200Ok, *http.Response, error) {
	var (
...
func (a *CharacterApiService) PostCharactersCharacterIdCspa(ctx context.Context, characterId int32, characters []int32, localVarOptionals *CharacterApiPostCharactersCharacterIdCspaOpts) (float32, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
