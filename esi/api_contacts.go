...
func (a *ContactsApiService) PostCharactersCharacterIdContacts(ctx context.Context, characterId int32, contactIds []int32, standing float32, localVarOptionals *ContactsApiPostCharactersCharacterIdContactsOpts) ([]int32, *http.Response, error) {
	var (
...
func (a *ContactsApiService) PutCharactersCharacterIdContacts(ctx context.Context, characterId int32, contactIds []int32, standing float32, localVarOptionals *ContactsApiPutCharactersCharacterIdContactsOpts) (*http.Response, error) {
	var (
